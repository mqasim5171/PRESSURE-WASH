      ...
      <div className="text-center">
        ...
        <div className="mb-12">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
            <Button 
              ...
              className="bg-white text-blue-600 hover:bg-blue-50 px-8 py-4 text-lg font-bold shadow-xl hover:shadow-2xl transform hover:-translate-y-1"
            >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 border-t border-blue-700 pt-12">
          ...
          <div className="text-center">
            ...
            <p className="text-blue-200 text-sm">247+ reviews</p>
          </div>

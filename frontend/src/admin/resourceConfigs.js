...
export const servicesConfig = {
  ...
  emptyDefaults: { name: "", slug: "", shortDescription: "", fullDescription: "", icon: "", features: [], benefits: [], included: [], ctaLabel: "Get a Free Quote", ctaUrl: "/contact", isPrimary: false, primaryOrder: null, displayOrder: 0, published: true },
  fields: [
    { name: "name", label: "Service Name", required: true },
    { name: "slug", label: "URL Slug", helpText: "Public URL: /services/{slug}. Leave blank to auto-generate from the name - changing an existing slug after the page has been shared/indexed breaks the old link, so edit it deliberately." },
    { name: "shortDescription", label: "Short Description", type: "textarea", rows: 2, fullWidth: true },
    { name: "fullDescription", label: "Full Description", type: "textarea", rows: 5, fullWidth: true, helpText: "Shown as the subtitle under the page heading." },
    ...
    { name: "features", label: "What's Included (bullets)", type: "array", fullWidth: true, placeholder: "e.g. Drone-powered access" },
    { name: "benefits", label: "Benefits (optional)", type: "array", fullWidth: true },
    { name: "included", label: "Also Included (optional)", type: "array", fullWidth: true },
...
export const packagesConfig = {
  ...
  emptyDefaults: {
    name: "", slug: "", tagline: "", shortDescription: "", fullDescription: "",
    price: null, startingFrom: false, unitLabel: "",
    features: [], excludedFeatures: [],
    ctaLabel: "Get This Package", ctaUrl: "/contact",
    displayOrder: 0, published: true, featured: false, recommended: false, serviceIds: [],
  },
  fields: [
    { name: "name", label: "Package Name", required: true },
    { name: "slug", label: "URL Slug", helpText: "Public URL: /packages/{slug}. Changing this after the page has been shared/indexed breaks the old link - only edit it deliberately." },
    { name: "tagline", label: "Tagline (one-line benefit)", fullWidth: true },
    { name: "shortDescription", label: "Short Description", type: "textarea", rows: 2, fullWidth: true, helpText: "Shown as the lead paragraph on the package page." },
    { name: "fullDescription", label: "Full Description", type: "textarea", rows: 4, fullWidth: true },
    { name: "packageImageMediaId", label: "Hero Image (Desktop)", type: "image", urlField: "packageImageUrl", category: "packages" },
    { name: "packageMobileImageMediaId", label: "Hero Image (Mobile, optional)", type: "image", urlField: "packageMobileImageUrl", category: "packages", helpText: "Portrait crop. Falls back to the desktop image if left blank." },
    ...
    { name: "price", label: "Price ($, optional)", type: "number", helpText: "Leave blank for \"Custom pricing - get a free quote\" instead of a fixed number." },
    { name: "startingFrom", label: "Show as \"Starting from\"", type: "boolean", helpText: "Only applies when Price is set." },
    { name: "unitLabel", label: "Unit Label (optional)", placeholder: "e.g. per visit" },
    { name: "originalPrice", label: "Was Price ($, for a discount)", type: "number" },
    { name: "offerPrice", label: "Now Price ($, for a discount)", type: "number" },
    { name: "offerEndDate", label: "Offer Ends", type: "datetime", helpText: "Leave blank for no time-limited offer. While active, the page shows a live countdown and switches back to normal pricing automatically once this passes." },
    { name: "offerBadge", label: "Offer Badge Text (optional)", placeholder: "e.g. WINTER SPECIAL", helpText: "Leave blank to auto-show \"SAVE X%\" computed from Was/Now price." },
    { name: "ctaLabel", label: "CTA / Button Label" },
    { name: "ctaUrl", label: "CTA URL", helpText: "Not used by the package card (which always links to this package's own page) - this is where the page's own quote button/form submits to conceptually, kept for reference." },
    { name: "serviceIds", label: "Linked Services", type: "services", fullWidth: true, helpText: "Shown as \"Services Included\" on the package page, each linking to its own service page." },
...
export const bundlesConfig = {
  ...
  emptyDefaults: { name: "", slug: "", tagline: "", badge: "", includes: [], ctaLabel: "Get This Bundle", ctaUrl: "/contact", displayOrder: 0, published: true },
  fields: [
    { name: "name", label: "Bundle Name", required: true },
    { name: "slug", label: "URL Slug", helpText: "Public URL: /packages/{slug} (bundles share the same page type as individual packages). Changing this after the page has been shared/indexed breaks the old link." },
    { name: "tagline", label: "Tagline (one-line benefit)", fullWidth: true },
    { name: "shortDescription", label: "Short Description", type: "textarea", rows: 2, fullWidth: true },
    { name: "fullDescription", label: "Full Description", type: "textarea", rows: 4, fullWidth: true },
    { name: "imageMediaId", label: "Hero Image (Desktop)", type: "image", urlField: "imageUrl", category: "bundles" },
    { name: "mobileImageMediaId", label: "Hero Image (Mobile, optional)", type: "image", urlField: "mobileImageUrl", category: "bundles" },
